...
function formatFindingsForLLM(task: Task, run: TaskRun, findings: Finding[]): string {
  ...
  lines.push("");
  lines.push("IMPORTANT: For `suppress` actions, `suppress_scope` determines how to suppress:");
  lines.push('- "match" — suppress this exact matched text (default). Omit suppress_match; it is auto-filled.');
  lines.push('- "file" — suppress all findings in this file. Omit suppress_file; it is auto-filled.');
  ...
  lines.push('    "index": 2,');
  lines.push('    "action": "suppress",');
  lines.push('    "reason": "entire file is safe",');
  lines.push('    "suppress_scope": "file"');
  lines.push("  },");
  lines.push("  {");
  lines.push('    "index": 3,');
  lines.push('    "action": "suppress",');
  lines.push('    "reason": "rule is too noisy",');
  lines.push('    "suppress_scope": "rule"');
  lines.push("  },");
  lines.push("  {");
  lines.push('    "index": 4,');
